                    ...
                    <div className="container">
                        ...
                        <Collapse isOpen={this.state.isNavOpen} navbar>
                            <Nav navbar>
                                ...
                                {this.props.auth.userinfo && (this.props.auth.userinfo.admin || this.props.auth.userinfo.staff) ? (
                                    <NavItem className="">
                                ...
                                }
                                {
                                    (this.props.auth.isAuthenticated && (this.props.auth.userinfo.admin || this.props.auth.userinfo.staff)) ? (
                                        <React.Fragment>
                                            ...
                                            <NavItem onClick={this.toggleNav} className="ml-2">
                                                <NavLink className="nav-link text-primary" to="/status">
                                                    <span className="fa fa-list-ul" /> Status
                                                </NavLink>
                                            </NavItem>
                                            <NavItem onClick={this.toggleNav} className="ml-2">
