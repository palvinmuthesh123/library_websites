...
import {
  ...
  registerUser, editUser, editPassword, postIssue, returnIssue, fetchIssues, fetchUsers, statusIssue
...
const mapDispatchToProps = dispatch => ({
  ...
  statusIssue: (issueId, status) => (dispatch(statusIssue(issueId, status)))
});
...
class Main extends Component {
  ...
  componentDidMount() {
    ...
    if (this.props.auth.isAuthenticated) {
      this.props.fetchIssues((!this.props.auth.userinfo.admin && !this.props.auth.userinfo.staff));
    }
    if ((this.props.auth.isAuthenticated && this.props.auth.userinfo.admin) || 
    (this.props.auth.isAuthenticated && this.props.auth.userinfo.staff)) {
  ...
  render() {
    const BookWithId = ({ match }) => {
      ...
      return (
        <BookDetail book={selectedBook}
          ...
          isAdmin={(this.props.auth.userinfo == null) ? false : (this.props.auth.userinfo.admin || this.props.auth.userinfo.staff)}
        />
      );
    };
    ...
    const UserWithId = ({ match }) => {
      ...
      return (
        <UserDetail user={selectedUser}
          ...
          userss={this.props.auth.userinfo}
        />
      );
    };
    ...
    const PrivateRouteAdmin = ({ component: Component, ...rest }) => (
      <Route {...rest} render={(props) => (
        (this.props.auth.isAuthenticated && this.props.auth.userinfo.admin) || (this.props.auth.isAuthenticated && this.props.auth.userinfo.staff)
          ? <Component {...props} />
          : <Redirect to={{
              pathname: '/home',
              state: { from: props.location }
    ...
    const PrivateRoute = ({ component: Component, ...rest }) => (
      <Route {...rest} render={(props) => (
        this.props.auth.isAuthenticated && (!this.props.auth.userinfo.admin || !this.props.auth.userinfo.staff)
          ? <Component {...props} />
          : <Redirect to={{
            pathname: '/home',
            state: { from: props.location }
      ...
      <div className="App">
        ...
        <Switch location={this.props.location}>
          ...
          <Route exact path='/search' component={() => <Search
            ...
            isAdmin={(this.props.auth.userinfo == null) ? false : (this.props.auth.userinfo.admin || this.props.auth.userinfo.staff)}
            // isStaff={(this.props.auth.userinfo == null) ? false : (this.props.auth.userinfo.staff)}
            toggleEditModal={this.toggleEditModal}
          ...
          <PrivateRouteAdmin exact path='/list_students' component={() => <UserList
            users={this.props.users.users.filter((user) => (!user.admin && !user.staff))}
          ...
          />}
          />
          <PrivateRouteAdmin exact path='/list_staffs' component={() => <UserList
            users={this.props.users.users.filter((user) => (user.staff))}
            usersLoading={this.props.users.isLoading}
            usersErrMess={this.props.users.errMess}
          />}
          />
          <PrivateRouteCommon exact path='/issue' component={() => <Issue
            auth={this.props.auth}
            books={this.props.books.books}
            booksLoading={this.props.books.isLoading}
            booksErrMess={this.props.books.errMess}
          ...
          />} />
          <PrivateRouteAdmin exact path='/status' component={() => <Status
            issues={this.props.issues}
            auth={this.props.auth}
            statusIssue={this.props.statusIssue}
          />} />
          <PrivateRouteAdmin path='/users/:userId' editUser={this.props.editUser} component={UserWithId} />
